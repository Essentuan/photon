...
const int colortex13Format = RGBA16F;        // full res    | rendered translucent layer (translucent -> c1), motion vectors (c4)
...
const int colortex17Format = R16f; // Exposure history \w super res
